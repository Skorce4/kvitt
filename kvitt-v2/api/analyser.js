...
- PROFESJONELL SALGSHJELP ER POSITIVT NÅR DEN ER OPPLYST. Hvis annonsen opplyser at en profesjonell aktør (f.eks. Rebil) bistår selgeren, og det står klart at aktøren IKKE er part i avtalen og at bilen selges privat, er dette et PLUSS (level \"ok\") og skal ikke trekke ned. Tydelig opplyst bistand betyr bedre dokumentasjon og ryddigere prosess, og selve åpenheten om rollefordelingen fjerner nettopp den uklarheten som ellers kunne oppstått. Ikke flagg dette som risiko for \"uklar partsstatus\" når rollene står klart beskrevet. Bare hvis rollefordelingen er UKLAR eller motstridende (f.eks. at annonsen veksler mellom å fremstå som forhandlersalg og privatsalg), skal du flagge det som en risiko.
- GJENVÆRENDE NYBILGARANTI/FABRIKKGARANTI ER SVÆRT VIKTIG. Hvis annonsen viser at bilen fortsatt har nybilgaranti, fabrikkgaranti eller forlenget produsentgaranti (f.eks. «nybilgaranti til 2027», «5 års garanti», «garanti gjenstår»), reduserer det reklamasjonsrisikoen mot DEG som selger dramatisk: mekaniske feil dekkes normalt av produsent eller merkeforhandler, ikke av deg. Da skal eksponering_nok settes LAVT (typisk 0-10 000 kr), og sannsynlighetene i skadeRisiko settes KRAFTIG NED for alt garantien dekker (motor, girkasse, elektronikk, batteri på elbil). Selgers restrisiko gjelder da hovedsakelig det garantien IKKE dekker: slitedeler, lakk- og karosseriskader, feilaktige eller fortiede opplysninger. Flagg garantien som positiv (level \"ok\") og si i begrunnelsen at garantien bærer mesteparten av risikoen.
...
Hver subjektiv frase du flagger (f.eks. «strøken», «meget godt vedlikeholdt», «går som ei kule», «pent brukt», «alt man kan ønske seg») skal du føre opp i listen "banned". Denne listen brukes senere til å skrive en forbedret annonse uten disse frasene, så vær nøyaktig. MEN: en FAKTISK produsent- eller nybilgaranti er ikke et subjektivt garantiutsagn. Skill tydelig mellom selgerens egne løfter om tilstand («garantert feilfri», «går som ei kule») som ER risiko, og en dokumenterbar fabrikkgaranti som er et faktum og en FORDEL for selgeren.
